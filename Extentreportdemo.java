...
//import practiceext.Utitily.Utility;
...
public class Extentreportdemo {
	   // Create global variable which will be used in all method
		...
		public void setup()
		{
		    ExtentHtmlReporter reporter=new ExtentHtmlReporter("./Reportextent/globaldata.html");
		...
		public void loginTest() throws IOException
		{
			...
			driver.get("http://www.globaldata.com");
			System.out.println("title is "+driver.getTitle());
			Assert.assertTrue(driver.getTitle().contains(" Aisha Ruman"));
		}
		...
		public void tearDown(ITestResult result) throws IOException
		{
			...
			{
				String temp=Utility.getScreenshotAs( driver);
